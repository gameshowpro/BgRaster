...
- Treat `docs/developer/coding-standards.md` as authoritative for all coding style and architecture guidance.
...
- If any requested change conflicts with `docs/developer/coding-standards.md`, follow the standards and surface the conflict clearly.

...
Generated PNGs are expected in `docs/sample-output` and should be regenerated with `scripts/generate-documentation.ps1`.
...
- Output image: ![Crosshair sample](sample-output/crosshair.png)
